...
sof      = json.loads(pathlib.Path("test_sof_ceuta.json").read_text())
invoice  = json.loads(pathlib.Path("test_invoice_ceuta.json").read_text())
tariff   = json.loads(pathlib.Path("tariffs/ceuta.json").read_text())
