...
sof      = json.loads(pathlib.Path("test_sof_cadiz_bay.json").read_text())
invoice  = json.loads(pathlib.Path("test_invoice_cadiz_bay.json").read_text())
tariff   = json.loads(pathlib.Path("tariffs/cadiz_bay.json").read_text())
