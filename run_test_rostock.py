...
sof      = json.loads(pathlib.Path("test_sof_rostock.json").read_text())
invoice  = json.loads(pathlib.Path("test_invoice_rostock.json").read_text())
tariff   = json.loads(pathlib.Path("tariffs/rostock.json").read_text())
