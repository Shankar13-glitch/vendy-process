...
sof      = json.loads(pathlib.Path("test_sof_huelva.json").read_text())
invoice  = json.loads(pathlib.Path("test_invoice_huelva.json").read_text())
tariff   = json.loads(pathlib.Path("tariffs/huelva.json").read_text())
