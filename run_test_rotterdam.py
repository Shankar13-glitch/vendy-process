...
sof      = json.loads(pathlib.Path("test_sof_rotterdam.json").read_text())
invoice  = json.loads(pathlib.Path("test_invoice_rotterdam.json").read_text())
tariff   = json.loads(pathlib.Path("tariffs/rotterdam.json").read_text())
